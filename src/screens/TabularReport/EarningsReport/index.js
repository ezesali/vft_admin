...
export function EarningsReport() {
  ...
  const [fromDateEarn, setFromDateEarn] = useState(null)

  const [toDateEarn, setToDateEarn] = useState(null)
...
const getEarningsData = async() => {
    ...
    const exportToExcel = async(excelData, fileName) => {
        ...
        userExport = userExport.map((val) => {
            return {
                ...
                'Purchased Date & Time': val.purchased_date,
            }
        })
        ...
        const wb = { Sheets: { 'Earnings Report': ws }, SheetNames: ['Earnings Report'] };
    ...
    const actions = [
        { 
            ...
            isFreeAction: true,
            onClick: (event) => exportToExcel(earnings, 'VFT_Earnings_Report')
        }
    ]
    ...
    <>
        ...
        <div style={{marginLeft: navisOpen ? '180px' : null}} className="dashboardContainerProfile">
                    ...
                    <div className="profileHead">
                        <nav aria-label="breadcrumb" role="navigation">
                            <ol className="breadcrumb">
                                ...
                                <>&nbsp;&nbsp;&gt;&nbsp;&nbsp;</>
                                <li className="breadcrumb-item active" aria-current="page">Earnings Report</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div className="contentDate"> 
                ...
                <h3 className="reportName">Earnings Report</h3>
            ...
            {earnings.length > 0 ?
                <div className="tableView">
                    <Table columns={columns} rows={earnings} actions={actions} title={'Earnings Report List'}/>
                </div>
            :
             
                <div className="tableView">
                    <p className="reportMessage">There are not earnings created between those Dates</p>
                </div>
            }
