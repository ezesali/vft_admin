...
export function EditRestaurantImage() {
  ...
  const [loading, setLoading] = useState(false)
    ...
    useEffect(() => {
        ...
        getRestaurantImgData();

        setLoading(false)
    
    }, [])

    async function getRestaurantImgData() {
        const docTourRef = doc(db, "restaurant_image_master",''+parseInt(id)+'')
        ...
        if (docTourSnap.exists()) {
            ...
            const tourData = {
                restaurant_id: docTourSnap.data().restaurant_id,
                image: docTourSnap.data().url,
                description: docTourSnap.data().description
            }

            setRestaurantImg(tourData)
        }
    };
    ...
    const handleClose = () => {
     ...
     const onChangeDescription = e => {
        ...
        let newRestaurant = restaurantImg
        newRestaurant.description = e.target.value

        setRestaurantImg(newRestaurant)
    ...
    const submitEdit = async() => {
        ...
        const docCityRef = doc(db, "restaurant_image_master",''+parseInt(id)+'')
        ...
        getDoc(docCityRef).then((docCitySnap) => {
            ...
            if (docCitySnap.exists()) {
                ...
                updateDoc(docCityRef, {
                    url            : imageURL,
                    description    : restaurantImg.description ? restaurantImg.description : '',
                    ...
                    <div className="profileHead">
                        <nav aria-label="breadcrumb" role="navigation">
                            <ol className="breadcrumb">
                                ...
                                <>&nbsp;&nbsp;&gt;&nbsp;&nbsp;</>
                                <li className="breadcrumb-item">
                                    <Link to={"/view_restaurant/"+restaurantImg.restaurant_id}  className="Linkp">
                                        View Restaurant
                                    </Link>
                                </li>
                                <>&nbsp;&nbsp;&gt;&nbsp;&nbsp;</>
                                <li className="breadcrumb-item active" aria-current="page">Edit Restaurant Image</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div className="rowViewCity">
                ...
                <div className="cityInputs">
                    ...
                    <div className="viewImageCity">
                        ...
                        <img
                            src={imageUpload ? imageUpload : restaurantImg.image ? restaurantImg.image : NoCity}
                            alt={''}
                    ...
                    <div className="cityInputs">
                        ...
                        <TextField InputLabelProps={{shrink: true}} onChange={onChangeDescription} defaultValue={restaurantImg.description} multiline label="Description (optional)" placeholder="Enter Description" id="outlined-basic" variant="outlined" />
